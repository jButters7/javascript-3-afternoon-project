...
//Code Here
let totalPopulation = populations.reduce((acc, el, index, array)=>{
  return (acc += el)
}, 0)
...
let getBob = purchases.filter((element, index, array)=>{
...
let bobsTotal = getBob.reduce((acc, element, index, array)=>{
